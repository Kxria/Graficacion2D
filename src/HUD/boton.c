...
Figuras* boton_triangulo(void) {
    ...
    triangulo->triangulo.p1.unpack.x = 50;
    triangulo->triangulo.p1.unpack.y = 430;

    triangulo->triangulo.p2.unpack.x = 100;
    triangulo->triangulo.p2.unpack.y = 350;

    triangulo->triangulo.p3.unpack.x = 150;
    triangulo->triangulo.p3.unpack.y = 430;
